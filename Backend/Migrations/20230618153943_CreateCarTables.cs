    ...
    public partial class CreateCarTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarSituations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CarSituations_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CarSituations_Situations_SituationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarSituations_CarId",
                table: "CarSituations",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_CarSituations_SituationId",
                table: "CarSituations",
                column: "SituationId");
